...
public class ResumeTwo {
    ...
    private static final String fullName_2 = "Marlyn Manson";
    ...
    static {
        r2.getContacts().put(ContactType.CELL, cellFirst);
        r2.getContacts().put(ContactType.EMAIL, eMailFirst);
        r2.getContacts().put(ContactType.SKYPE, skypeFirst);
        r2.getInformationSections().put(SectionType.OBJECTIVE, objectiveFirst);
        r2.getInformationSections().put(SectionType.PERSONAL, personalFirst);
        ...
        r2.getInformationSections().put(SectionType.QUALIFICATIONS, qualificationFirst);
        ...
        r2.getInformationSections().put(SectionType.EXPERIENCE, organizationSection);

        universitiesEmploymentList.add(study);
        university.setEmployment(universitiesEmploymentList);
        universitiesList.add(university);
        r2.getInformationSections().put(SectionType.EDUCATION, educationSection);
    }
